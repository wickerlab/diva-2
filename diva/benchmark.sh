...
python ./test.py --dataset enron --step 0.1 --method feature_collision --max_sample 2000
python ./test.py --dataset breast_cancer --step 0.1 --method feature_collision --max_sample 2000
python ./test.py --dataset spambase --step 0.1 --method feature_collision --max_sample 2000
